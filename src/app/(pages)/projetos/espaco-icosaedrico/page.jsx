...
const ProjetoUpload = () => {
  ...
  return (
    <div id="projetos" className="max-w-[1080px] mx-auto pt-[15em] bg-black">
      ...
      <div className="p-5">
        <h1 className="text-left text-5xl py-4 px-4">
          Espaço Icosaédrico: quando a dança encontra a fotografia em movimento.
        </h1>
        <p className="text-xl font-thin text-justify px-4 py-4">
          Nasceu de uma brincadeira/experimento com fotos, transformando-as em
          fotodanças potentes. Agora, por que não compartilhar esse movimento
          com vocês?
        </p>
        ...
        <div className="flex items-center justify-center">
          <Link href={"/projetos/espaco-icosaedrico/album"}>
            <Button
              icon={<AiOutlineMenu />}

...
const About = () => {
  return (
    <div className=" text-black mx-auto bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-white via-[#C2B6A9] to-[#DEC8A6] lg:h-[1440px]">
      <div className="mx-auto text-center py-8">
        <div className="mx-auto block max-w-[1260px]">
          <h1 className="text-4xl">Prof. Matheus Carneiro</h1>
        ...
        <div className="mx-auto lg:flex justify-evenly max-w-[1440px]">
          ...
          <div className="inline-block backdrop-blur-0 text-left">
            <Milestone
            ...
            <Milestone
              ...
              description={"Professor de Ballet Clássico"}
              institute={"Lorem Ipsum"}
              date={"Janeiro 2022 - Dezembro 2022"}
            />
            <Milestone
              icon={<FaBriefcase size={30} />}
